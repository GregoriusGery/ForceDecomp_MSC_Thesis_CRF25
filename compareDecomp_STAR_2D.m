...
% folder_name = '4. re 140\report_COUPLED_v5_tquarter\edited'; %BALANCED
% folder_name = '4. re 140 STAR\report_COUPLED_v5.5C_thalf_constRho\edited';  % BALANCED
folder_name = '4. re 140 STAR\report_COUPLED_v6\edited';  % BALANCED
% folder_name = '5. re 5000 STAR\report_v8\edited';  % BALANCED
...
for c = 1:num_cvs
    ...
    % Cd_EnthFlux_h{c}   = (Hflux_right / Vinf) / q;
    % Cd_EnthFlux_p{c}   = (Pflux_right / Vinf) / q;
    % Cd_EnthFlux_tau{c} = (Tauflux_right / Vinf) / q;
    % Cd_Enthalpy{c}     = ((d_enth_dt + Hflux_right + Pflux_right + Tauflux_right) / Vinf) / q;
...
%% 4. ENERGY DELTAS (BETWEEN CONTROL VOLUMES) - SEPARATED METHOD
